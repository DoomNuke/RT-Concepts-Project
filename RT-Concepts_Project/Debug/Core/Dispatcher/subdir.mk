...
C_SRCS += \
../Core/Dispatcher/Dispatcher.c 

OBJS += \
./Core/Dispatcher/Dispatcher.o 

C_DEPS += \
./Core/Dispatcher/Dispatcher.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Dispatcher/%.o Core/Dispatcher/%.su Core/Dispatcher/%.cyclo: ../Core/Dispatcher/%.c Core/Dispatcher/subdir.mk
...
clean: clean-Core-2f-Dispatcher

clean-Core-2f-Dispatcher:
	-$(RM) ./Core/Dispatcher/Dispatcher.cyclo ./Core/Dispatcher/Dispatcher.d ./Core/Dispatcher/Dispatcher.o ./Core/Dispatcher/Dispatcher.su

.PHONY: clean-Core-2f-Dispatcher
